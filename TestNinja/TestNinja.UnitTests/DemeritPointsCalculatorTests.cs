...
namespace TestNinja.UnitTests
{
    ...
    public class DemeritPointsCalculatorTests
    {
        ...
        [TestCase(-1)]
        [TestCase(301)]
        public void CalculateDemeriPoints_SpeedIsOutOfRange_ThrowArgumenOutOfRangeException(int speed)
        {
        ...
        [TestCase(70,1)]
        [TestCase(75,2)]
        public void CalculateDemeriPoints_WhenCalled_ReturnDemeritPoints(int speed, int expectedResult)
        {
            var calculator = new DemeritPointsCalculator();
